type LockedKind = "ranking" | "historial"

interface LockedProps {
  kind?: LockedKind
}

const COPY: Record<LockedKind, { overline: string; title: string; sub: string; foot: string }> = {
  ranking: {
...
export default function Locked({ kind = "ranking" }: LockedProps) {
